 ...
 */
#define DEFAULT_AWAKE_IDEAL_FREQ 988000
 ...
 * also when suspended).
 */
#define DEFAULT_SLEEP_IDEAL_FREQ 754000
 ...
 */
#define DEFAULT_RAMP_UP_STEP 234000
 ...
 */
#define DEFAULT_RAMP_DOWN_STEP 257000
static unsigned int ramp_down_step;

/*
 * CPU freq will be increased if measured load > max_cpu_load;
 */
#define DEFAULT_MAX_CPU_LOAD 66
static unsigned long max_cpu_load;

/*
 * CPU freq will be decreased if measured load < min_cpu_load;
 */
#define DEFAULT_MIN_CPU_LOAD 33
